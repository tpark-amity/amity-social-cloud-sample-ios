 ...
 */
- (nonnull instancetype)initWithClient:(nonnull EkoClient *)client NS_DESIGNATED_INITIALIZER DEPRECATED_MSG_ATTRIBUTE("EkoMediaRepository has been depreciated. Please use `downloadMedia(_:)` method in EkoMessageRepository. This class will be removed in future release");
